...
!function ($) {
    ...
    BootstrapTable.prototype.initContainer = function () {
        this.$container = $([
            ...
            this.options.paginationVAlign === 'bottom' || this.options.paginationVAlign === 'both' ?
                '<div class="fixed-table-pagination" style="padding: 0 16px;"></div>' :
                '',
            '</div>',
            '</div>'].join(''));
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open btn-group" title="%s">',
                ...
                '<button type="button" style="height: 35px;border-radius: 23px;padding-left: 5px;padding-top: 9px;padding-right: 8px;" class="btn' + (this.options.iconSize == undefined ? '' : ' btn-' + this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">',
                sprintf('<i class="%s %s" style="font-size:21px;color:#969c9c"></i>', this.options.iconsPrefix, this.options.icons.columns),
        ...
        if (this.options.search) {
            ...
            html.push(
        		'<div class="columns columns-right btn-group pull-right">'+
        			'<button type="button" style="height: 36px;border-radius: 23px;padding-left: 7px;padding-top: 10px;padding-right: 8px;" id="btnViewSearch" class="btn dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i id="iconViewSearch" style="font-size:21px;color:#969c9c" class="glyphicon md-search"></i> <span class="caret"></span></button>'
        		+'</div>'+
                '<div class="pull-' + this.options.searchAlign + ' search" style="display:none"><div class="form floating-label" style="margin-top: -19px;line-height:26px"><div class="form-group">',
                sprintf('<input class="form-control' + (this.options.iconSize === undefined ? '' : ' input-' + this.options.iconSize) + '" type="text" style="height:30px;margin-bottom:16px;width:85px"> <label style="font-size:13px" for="username">Buscar</label>',
    ...
    BootstrapTable.prototype.initSearch = function () {
        ...
        //INI dfloresgonz 20.05.2016
        if(this.searchText.length < this.options.minSizeSearch) {
        	return false;
        }
        //FIN dfloresgonz 20.05.2016
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push('</div>',
            ...
            '<li class="page-first"><a href="javascript:void(0)"><i class="material-icons">' + this.options.paginationFirstText + '</i></a></li>',
            '<li class="page-pre"><a href="javascript:void(0)"><i class="material-icons">' + this.options.paginationPreText + '</i></a></li>');
        ...
        html.push(
            '<li class="page-next"><a href="javascript:void(0)"><i class="material-icons">' + this.options.paginationNextText + '</i></a></li>',
            '<li class="page-last"><a href="javascript:void(0)"><i class="material-icons">' + this.options.paginationLastText + '</i></a></li>',
            '</ul>',
            '</div>');
